                        ...
                        <form class="d-flex flex-column py-3" method="POST">
                            <div class="d-flex my-1">
                                ...
                                <div class="form-floating ml-2">
                                    <input type="text" class="form-control" id="tel" placeholder="Tel" name="tel_usuario" oninput="formTel()" maxlength="15" required>
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="cpf" placeholder="CPF" name="cpf_usuario" oninput="formatarCPF()" maxlength="14" required>
