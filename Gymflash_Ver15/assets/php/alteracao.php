...
//ALTER EMAIL DA ACADEMIA===========================================================================================
 if(isset($_POST['email'])){
    ...
    function_alert("O CAMPO QUE DESEJA ATUALIZAR NÃO PODE SER VAZIO");
      ...
      function_alert('ESTE EMAIL ESTA INDISPONÍVEL NO MOMENTO! Ou voc~e está tentando cadastrar o mesmo email!<br>
       Gentileza escolher outro email ou entar em contato com o SUPORTE');
  }
}
 }
