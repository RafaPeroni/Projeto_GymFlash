            ...
            <form class="row" action="" method="GET">
                <div class="col-3">
                    <div class="input-group w-100">
                        <input type="submit" name="BTN-Search" value="Buscar"
                            class="btn nav-link text-dark link-hover border px-2 fs-6 text-uppercase logcad"
                            id="buscar">
                        <input type="search" class="form-control rad" placeholder="" name="txt-Search"
                            aria-label="Example text with button addon" aria-describedby="buscar">
                            <div class="input-group w-100">

                                      <input type="submit" name="BTN-Search2" value="Buscar2"
                                         class="btn nav-link text-dark link-hover border px-2 fs-6 text-uppercase logcad"
                                         id="buscar">
                                      <input type="search" class="form-control rad" placeholder="" name="txt-Search2"
                                        aria-label="Example text with button addon" aria-describedby="buscar">
                            </div>
                        ...
                        <div class="row">
                            <?php if (isset($veri_acad2)) {
                                    ...
                                    <div class="card p-2 col-3 mx-2 mb-3 text-center"><!--Card das academias-->
                                        <h1 class="fs-4 text-dark">
                                            <?php 
                                           ECHO $IDpb3['Nome_da_academia']; ?> <!--Nome da Academia-->
                                        </h1>
                                        <div class="fs-6">
                                            <?php echo $dados['Bairro_academia'] ?> <!--Nome do Responsável-->
                                        </div>
                                        <div class="display-none">
                                            <?php   $cred = $dados['FK_Credencial_academia'];?><!--ID da Academia-->
                                        </div>
                                     </form>
                                        <div class="col d-flex justify-content-center">
                                        <form action="" method="post">
