                ...
                <div class="row my-2 w-50 align-self-center">
                    <div class="col">
                        ...
                        <div class="row my-2">
                            ...
                            <input readonly class="form-control form-control-lg" type="file" name="img" accept=".png, .jpg, .jpeg" id="formFile" placeholder="Escolha">
                        </div>
                        <div class="row my-4 form-floating">
                            <textarea name="coment" id="coment" placeholder="Deixe um Comentario" class="border-2 bg-transparent form-control" style="height: 100px"><?php echo $dados['Comentario']; ?></textarea>
                ...
                <div class="row my-2">
                    ...
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <div class="row my-2 w-50">
                            ...
                            <div class="col-auto w-25 pl-2 form-floating">
