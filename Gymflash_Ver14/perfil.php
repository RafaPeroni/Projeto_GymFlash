...
<head>
    ...
    <title>GymFlash - Perfil Academia</title>
    <style>
    ...
    <div class="row">
        ...
        <div class="row col-9 h-100">
            ...
            <div class="container row h-75">
                <section class="container border border-2 shadow-lg m-2 rounded-5 overflow-hidden p-3">
                    <?php  include_once(__DIR__ . "/{$_GET['dir']}/{$_GET['file']}.php"); ?>
                </section>
            </div>
        </div>
    </div>
