                        ...
                        <div class="row my-2 w-50">
                            <div class="col-auto w-75 p-0 form-floating">
                                <input class="border-2 bg-transparent form-control form-control-lg " type="text"
                                    ...
                                    value="<?php echo $dados2['Bairro_academia']; ?>" readonly>
                                <label>Bairro:</label>
                            </div>
                            <div class="col-auto w-25 pr-0 form-floating">
                                <input class="border-2 bg-transparent form-control form-control-lg " type="text" name="num"
                                    id="num" placeholder="Número" value="<?php echo $dados2['Num_academia']; ?>">
                                <label class="ml-2">Numero:</label>
                            </div>
                        </div>
                        <div class="row my-2 w-50 justify-content-center">
                            <div class="col-auto w-100 p-0 form-floating">
                                <input class="border-2 bg-transparent form-control form-control-lg " type="text"
                                    name="complemento" id="complemento" placeholder="Complemento"
                                    value="<?php echo $dados2['Complemento_academia']; ?>">
                                <label>Complemento:</label>
                            </div>
                            <input
                                class="btn nav-link text-dark link-hover border-black mx-1 text-uppercase logcard py-3 my-2 w-50"
                                type="submit" value="Alterar Endereço" name='endereco2'>
                        </div>
                    </div>
                </div>
                <input
                    class="btn nav-link text-dark link-hover border-black mx-1 text-uppercase logcard py-3 mb-5 w-25 align-self-center"
                    name="desconectar" type="submit" value="Desconectar">
        </div>
