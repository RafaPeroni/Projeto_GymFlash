...
if (isset($_POST['endereco2'])) {
  ...
  //Complemento
  $alter_endereco = $conn->prepare("UPDATE EnderecoAcademia SET  Complemento_academia = '$cep' WHERE FK_Credencial_academia = :credencial");
  $alter_endereco->bindParam(':credencial', $_SESSION['Credencial_academia']);
  $alter_endereco->execute();
...
if (isset($_POST['delet_mod'])) {
  if (isset($_POST['selct_mod'])) {
    ...
    function_alert("Você não possui modalidades cadastradas");
  }
}
