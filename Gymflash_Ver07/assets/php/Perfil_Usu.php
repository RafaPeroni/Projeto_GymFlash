...
if(!isset($_SESSION['Credencial_usuario'])   ) {
    die("Você não pode acessar esta página porque não está logado. <p><a href=\"/Gymflash_Ver04/index.php\">RETORNAR</a></p>");
}
...
{
        session_destroy();
        die("Você foi deslogado com sucesso.<a href=\"/Gymflash_Ver04/index.php\">RETORNAR</a>");
}
//CONEÇÃO USUARIO
$busca_acad = $conn->prepare("SELECT * FROM Cadastrousuario WHERE Credencial_usuario = :credencial");
$busca_acad->bindParam(':credencial', $_SESSION['Credencial_usuario']);
$busca_acad->execute();
...
<!--NOME DO Usuário-->     
                <div class="col form-floating">
                    <input class="border-2 bg-transparent form-control form-control-lg" type="text" name="nameUsu"
                        id="nameUsu" placeholder="Nome do Usuário" >
               
                    <label >NOME ATUAL:  <?php echo $dados['Nome_usuario'];?></label>
                    <input type="submit" value="Alterar" name='name-usu'>
                </div>
<!--CPF DA ACADEMIA--> 
...
<!--EMAIL DO Usuário-->     
                <div class="col form-floating">
                    ...
                    <label >NOME ATUAL:  <?php echo $dados['Email_usuario'];?></label>
                    <input type="submit" value="Altera" name='name-usu'>
                </div>
<!--SENHA DA ACADEMIA--> 
                <div class="col form-floating ml-5">
                    <input class="border-2 bg-transparent form-control form-control-lg" type="text" name="nameAcad"
                        id="nameAcad" placeholder="Nome da Academia" >
                        <label >NOME ATUAL:  <?php echo $dados['Senha_usuario'];?></label>
                    <input type="submit" value="Alterar nome do academia" name='senha'>
                </div>
            </div>
<!--TELEFONE DA ACADEMIA-->
            <div class="row my-2">
                <div class="col form-floating">
                    ...
                    <input type="submit" value="Alterar senha" name='tell-usu'>
                </div>
