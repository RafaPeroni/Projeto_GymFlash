    ...
    <div class="container-fluid">
        <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom align-items-center">
            ...
            <ul class="nav nav-pills nav-justified align-items-center">
                ...
                <li class="nav-item">
                    <?php if (!isset($_SESSION['Credencial_academia'])) { ?>
                        <button type="button"
                            class="btn nav-link text-dark link-hover border mx-1 text-uppercase logcad"
                    ...
                    <?php
                        ...
                        <?php
                        echo "<a href=\"perfil.php?dir=assets/php&file=databaseconnect\" class=\"nav-link text-dark link-hover mx-1 text-uppercase\">Login: $_SESSION ['Nome_da_academia']</a>";
                    } ?>
                </li>
            </ul>
        </header>
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    <li class="nav-item fs-4 my-2">
                        <a href="perfil.php?dir=assets/php&file=databaseconnect"
                            class="nav-link link-body-emphasis d-flex align-items-center linkP" aria-current="page">
                            <svg class="bi pe-none me-2" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25"
                    ...
                    <li class="nav-item fs-4 my-2">
                        <a <?php if (isset($_SESSION['Credencial_academia'])) { ?>
                            href="perfil.php?dir=assets/php&file=altercad" <?php }
                             if (isset($_SESSION['Credencial_usuario'])){?>
                             href="perfil.php?dir=assets/php&file=alter_usu" <?php } ?> 
                            class="nav-link link-body-emphasis d-flex align-items-center linkP" aria-current="page">
                    ...
                    <li class="nav-item fs-4 my-2">
                        <a href="perfil.php?dir=assets/php&file=databaseconnect"
                            class="nav-link link-body-emphasis d-flex align-items-center linkP" aria-current="page">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 46 51"
                                fill="none">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M0.734955 7.21817C16.1919 5.93913 23.0632 0.716064 23.0632 0.716064C23.0632 0.716064 35.8891 7.21898 45.3525 7.21898C45.0143 8.88922 44.6946 10.4876 44.3883 12.0188C39.8238 34.8397 38.2475 42.7209 22.9849 50.7096C7.91227 42.4078 5.42443 34.032 0.734955 7.21817ZM18 20V29H27V20H25.5C25.5 20 26.5 15 22.5 15C18.5 15 19.5 20 19.5 20H18ZM24.5 20C24.5 20 25.5 16 22.5 16C19.5 16 20.5 20 20.5 20H24.5Z"
                                    fill="black" />
                                <path
                                    d="M23.25 22.25C22.8358 21.8358 22.1642 21.8358 21.75 22.25V22.25C21.3358 22.6642 21.3358 23.3358 21.75 23.75L22 24H22.5H23L23.25 23.75C23.6642 23.3358 23.6642 22.6642 23.25 22.25V22.25Z"
                                    fill="black" />
